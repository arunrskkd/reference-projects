    ...
    class OT_Meta_Box {
        ...
        function add_meta_boxes() {
            foreach ((array) $this->meta_box['pages'] as $page) {
                global $post;
                if (!isset($this->meta_box['page_templates']) || empty($this->meta_box['page_templates']) || in_array(get_page_template_slug($post->ID), $this->meta_box['page_templates'])) {
                    if ((!isset($this->meta_box['post_slugs']) || empty($this->meta_box['post_slugs']) || in_array($post->post_name, $this->meta_box['post_slugs']))) {
