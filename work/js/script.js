...
function restartcounter(ele){
  
  $(ele).prop('Counter',100000).animate({
      Counter: $(ele).text()
  }, {
      duration: 4000,
      // easing: 'swing',
...
particlesJS("particles-jssveven", {
  "particles": {
    "number": {
      "value": 60,
      "density": {
...
function openNav() {
 $(".navicn").toggleClass("change");
 $("#myNav").toggleClass("changewidth");
}
